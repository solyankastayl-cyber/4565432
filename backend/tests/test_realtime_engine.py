...
Base URL: https://portfolio-command-7.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://portfolio-command-7.preview.emergentagent.com').rstrip('/')
